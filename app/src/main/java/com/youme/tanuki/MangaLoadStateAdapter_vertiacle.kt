...
class MangaLoadStateAdapter_vertiacle : LoadStateAdapter<MangaLoadStateAdapter_vertiacle.LoadStateViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): LoadStateViewHolder {
        return LoadStateViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.sekelotn_manga_vertiacle, parent, false)
        )
    }
