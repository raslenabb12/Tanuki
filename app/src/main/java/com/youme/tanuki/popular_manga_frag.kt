...
class popular_manga_frag : Fragment() {
    private val viewModel: MangaViewModel by viewModels()
    private var popular_manga_Job: Job? = null
    private val loadStateAdapter = MangaLoadStateAdapter_2()
    private val adapter: PopularMangaPagingAdapter by lazy { PopularMangaPagingAdapter(::onMangaItemClick) }
    override fun onCreateView(
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.popular_manga.flowWithLifecycle(viewLifecycleOwner.lifecycle).collectLatest { pagingData ->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.apply {
            ...
            adapter=this@popular_manga_frag.adapter.withLoadStateFooter(
        ...
        swipeRefreshLayout.setOnRefreshListener {
            viewLifecycleOwner.lifecycleScope.launch {
                viewModel.popular_manga.collectLatest { pagingData ->
                    adapter.submitData(pagingData)
