...
class Favourites_manga_frag : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.set_userid(arguments?.getInt("userid"))
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.Favourites_pager.flowWithLifecycle(viewLifecycleOwner.lifecycle).collectLatest { pagingData ->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.apply {
            ...
            adapter=this@Favourites_manga_frag.adapter.withLoadStateFooter(
        ...
        swipeRefreshLayout.setOnRefreshListener {
            viewLifecycleOwner.lifecycleScope.launch {
                viewModel.Favourites_pager.collectLatest { pagingData ->
                    adapter.submitData(pagingData)
